...
{
  "$end", "error", "$undefined", "START", "END", "END_STATEMENT", "POINT",
  "LINE", "CIRCLE", "RECTANGLE", "SET_COLOR", "INT", "FLOAT", "$accept",
